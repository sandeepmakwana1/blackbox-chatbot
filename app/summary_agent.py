...
async def summarize_history(
    history: Sequence[BaseMessage], previous_summary=""
    ...
    msgs = prompt.format_messages(
        history=list(history), previous_summary=previous_summary
    )
    ...
    LOGGER.info(
        f"Summarization used {usage_info['total_tokens']} tokens (model: {usage_info['model']})"
    )
